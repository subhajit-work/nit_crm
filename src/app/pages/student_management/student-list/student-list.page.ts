  ...
  constructor(
    ...
    // ------ init function call start -------
      commonFunction(){
        ...
        this.headerUrlapi = 'student-header';
    
        // table list data url name
        this.listing_url = 'get-training-student';

        // delete url
        this.delete_url = 'student-delete';
          ...
          buttons: [
            {
              ...
              handler: () => {
                ...
                if(_identifire == 'single'){
                  ...
                  this.deleteListSubscribe = this.http.post(this.delete_url+'?email='+_items, fd).subscribe(
                  (res:any) => {
    ...
    // --------------- enable disable call start ---------------------
      ...
      enabledDisabled( _identifire, _item, _items ){
        ...
        this.itemsSubscribe = this.http.get('student-status?status='+_item+'&email='+_items).subscribe(
          (res:any) => {
            if(res.return_status > 0)
            {
