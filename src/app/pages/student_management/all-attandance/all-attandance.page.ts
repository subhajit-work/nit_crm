...
@Component({
  selector: 'app-all-attandance',
  templateUrl: './all-attandance.page.html',
  styleUrls: ['./all-attandance.page.scss'],
})

export class AllAttandancePage implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    // ------ init function call start -------
      commonFunction(){
        console.log("Fille Url Data.....",this.file_url);
        ...
        this.headerUrlapi = 'attendance-header';
    
        // table list data url name
        this.listing_url = 'attendance-All-list';

        // delete url
        this.delete_url = 'work-delete';
        ...
        this.api_parms = {
          project_id: this.parms_action_id,
          emp_id: this.get_user_dtls.emp_id,
      ...
      this.fromdate = moment(curentDate).format('YYYY-MM-DD');
    ...
    getsub_Module(){
      this.sub_Module = "get-modules-permission/"+this.parms_action_id;
    ...
    // filterEmpAttendance start
    filterEmpAttendance(_fromdate, _todate, _emp_id){
      console.log('_fromdate', _fromdate);
      console.log('_todate', _todate);
      console.log('_emp_id', _emp_id);
          ...
          buttons: [
            {
              ...
              handler: () => {
                ...
                if(_identifire == 'single'){
                  ...
                  this.deleteListSubscribe = this.http.post(this.delete_url+'?id='+_items, fd).subscribe(
                  (res:any) => {
  ...
  onSubmit(form:NgForm){
    ...
    this.form_api = 'attendance-fromdate-todate?'+'fromdate='+form.value.fromdate+'&'+'todate='+form.value.todate+'&emp_id='+form.value.emp_id;
     // get form value
    let excelLink = this.file_url+ '/api/' + this.form_api;
    console.log('excelLink', excelLink);
    
    window.open(excelLink);
    this.formSubmitSubscribe = this.http.get(this.form_api).subscribe(
      (response:any) => {
        console.log("Success Data Post......", response);
