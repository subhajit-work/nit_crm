  ...
  constructor(
    ...
    // ------ init function call start -------
      commonFunction(){
        ...
        this.headerUrlapi = 'task-header';
    
        // table list data url name
        this.listing_url = 'task-list/'+this.parms_action_id;

        // delete url
        this.delete_url = 'task-delete';


        this.onHeaderData(this.headerUrlapi);

        this.api_parms = {
          work_id:this.parms_action_id,
    ...
    getsub_Module(){
      this.sub_Module = "get-modules-permission/"+'6';
