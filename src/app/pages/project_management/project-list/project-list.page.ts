  ...
  constructor(
    ...
    // ------ init function call start -------
      commonFunction(){
        ...
        this.headerUrlapi = 'project-header';
    
        // table list data url name
        this.listing_url = 'project-list';

        // delete url
        this.delete_url = 'project-delete';
      ...
      addProject(){
        this.router.navigate(['/add-project'+'/'+'add/'+this._id]);
      }
    ...
    statusChange( _id, _item ){
      ...
      this.statuschange = 'project-status-update/'+_id;
      let fd = new FormData();
