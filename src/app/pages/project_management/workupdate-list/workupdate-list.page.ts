...
@Component({
  selector: 'app-workupdate-list',
  templateUrl: './workupdate-list.page.html',
  styleUrls: ['./workupdate-list.page.scss'],
})
export class WorkupdateListPage implements OnInit {
  ...
  constructor(
    ...
    // ------ init function call start -------
      commonFunction(){
        ...
        this.headerUrlapi = 'task-review-header';
        // table list data url name
        this.listing_url = 'task-review/'+this.parms_action_id;
    ...
    statusChangeLoading;
    statusChange( _identifire, _id, _item ){
      this.statusChangeLoading = true;
      this.statuschange = 'task-status-update'+_id;
      let fd = new FormData();
