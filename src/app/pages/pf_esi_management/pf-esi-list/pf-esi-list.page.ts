...
@Component({
  selector: 'app-pf-esi-list',
  templateUrl: './pf-esi-list.page.html',
  styleUrls: ['./pf-esi-list.page.scss'],
})
export class PfEsiListPage implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    // ------ init function call start -------
      commonFunction(){
        ...
        this.headerUrlapi = 'pf-esi-header';
    
        // table list data url name
        this.listing_url = 'pf-esi-list';

        // delete url
        this.delete_url = 'pf-esi-delete';
