...
export class PaymentListPage implements OnInit,OnDestroy {
  ...
  constructor(
    ...
    // ------ init function call start -------
      commonFunction(){
        ...
        this.headerUrlapi = 'payment-header';
    
        // table list data url name
        this.listing_url = 'get-payment';

        // delete url
        this.delete_url = 'payment-delete';
    ...
    // --------------- enable disable call start ---------------------
      ...
      enabledDisabled( _identifire, _item, _items ){
        ...
        this.itemsSubscribe = this.http.get('payment-status?status='+_item+'&id='+_items).subscribe(
          (res:any) => {
            if(res.return_status > 0)
            {
