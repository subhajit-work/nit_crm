  ...
  constructor(
    ...
    // ------ init function call start -------
      commonFunction(){
        ...
        this.listing_url = 'leave-All-list';
    ...
    //click item hilight back end 
     ...
     // ..... Approved Reject modal start ......
     async openApproved_reject(_identifier, _item, _items) {
      console.log('_identifier >>', _identifier);
      let approved_removed_modal;
      if(_identifier == 'Approved' || _identifier == 'Reject'){
        console.log("after Modal Open _identifier...", _identifier);
        
        approved_removed_modal = await this.modalController.create({
      ...
      approved_removed_modal.onDidDismiss()
      .then((getdata) => {
      ...
      return await approved_removed_modal.present();
    }
  // Approved Reject modal end 
